...
namespace CleanArchitecture.Infrastructure.Services
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<Response<AuthenticationResponse>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var response = await generateAuthResponse(user);
                    return new Response<AuthenticationResponse>(response, $"user {user.UserName} signed");
                }
                else
                {
                    throw new ApiException($"{result.Errors} error happened");
                }
            }
            else
            {
        ...
        private async Task<AuthenticationResponse> generateAuthResponse(ApplicationUser user) { 
